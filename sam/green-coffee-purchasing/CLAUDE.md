# Context: Green Coffee Purchasing
...
Team brief: [`docs/student/green-coffee-purchasing.md`](../../docs/student/green-coffee-purchasing.md).
...
The shared `sam/green_lots.json` catalog is real data (not a hint about your
internal model) — a lot is a specific purchase, not a refillable bucket of a coffee
type. Read it before you decide how to model "how much do we have."

## Do not

- **Do not collapse lots into a running total per origin.** A specific lot has a
  harvest year and a moisture reading that a running total throws away — decide
  deliberately whether that matters to you before flattening it.
